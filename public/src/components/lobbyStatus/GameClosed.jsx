...
export default function GameClosed() {
  return (
    <>
      <Center py={3}>
        <Box
            ...
            <Flex justify={"center"} mt={5}>
              ...
              >
                ...
                <Avatar
                  ...
                  alt={"Author"}
                  css={{
                    border: "4px solid #b0303c",
                  }}
                />
                <Stack spacing={0} align={"center"} mb={2}>
                  <Badge fontSize={13} colorScheme="red" mt={3} mb={3}>
                    Daniel Dias
                  </Badge>
                </Stack>
              </Box>
              ...
              >
                ...
                <Avatar
                  ...
                  alt={"Oponente"}
                  css={{
                    border: "5px solid #008514",
                  }}
                />
                <Stack spacing={0} align={"center"}>
                  <Badge colorScheme="green" fontSize={13} mt={3} mb={3}>
                    CHAPO
                  </Badge>
                </Stack>
              </Box>
